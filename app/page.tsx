      ...
      <section className="rounded bg-neutral-100 py-8 sm:py-12">
        <div className="mx-auto grid grid-cols-1 items-center justify-items-center gap-8 px-8 sm:px-16">
          <div className="max-w-md space-y-4">
            ...
            <Button asChild variant={"default"} className="inline-fliex items-center justify-center reounded-full px-6 py-3 bg-black text-white ">
              <Link href={"/products"} className="inline-flex items-center justify-center rounded-full px-6 py-3">Browse All Products</Link>
            </Button>
          </div>
        <Image alt="Hero image" width={450} height={450} src={products.data[0].images[0]}/>
        </div>
      </section>
